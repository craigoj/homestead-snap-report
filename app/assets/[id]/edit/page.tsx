...
export default function EditAsset() {
  ...
  const getAIValuation = async () => {
    ...
    try {
      ...
      toast.success(`Estimated value: $${result.estimated_value} (${result.confidence}% confidence) - ${dataSourceLabel}`);
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="flex items-center space-x-4">
        <Button variant="ghost" size="sm" onClick={() => router.push(`/assets/${id}`)}>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end space-x-4">
          <Button type="button" variant="outline" onClick={() => router.push(`/assets/${id}`)}>
            Cancel
          </Button>
