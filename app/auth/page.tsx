...
import { Loader2, Home, Shield, Mail } from 'lucide-react'
  ...
  const handleResendConfirmation = async () => {
    ...
    try {
      ...
      if (error && !error.message.includes('User already registered')) {
        ...
        toast.success("We've sent another confirmation email. Please check your inbox.", {
    ...
    try {
      ...
      if (error) {
        if (error.message.includes('User already registered')) {
          ...
          toast.error("Please enter a valid email address. Demo emails like 'user@demo.com' are not allowed.", {
        ...
        toast.success("We've sent you a confirmation link. Please check your email to complete signup.", {
  ...
  const handleMagicLink = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        toast.success("We've sent you a magic link. Click the link in your email to sign in.", {
          description: 'Check Your Email',
        })
      }
    } finally {
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold">SnapAsset AI</h1>
