...
export default function BulkAssetOperations() {
  ...
  const handleBulkUpdate = async () => {
    ...
    if (bulkUpdateData.estimated_value) {
      ...
      if (sanitized === null) {
        toast.error('Estimated value must be between $0 and $999,999,999');
    ...
    try {
      ...
      toast.success(`Updated ${selectedAssets.size} assets successfully`);
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      toast.success(`Deleted ${selectedAssets.size} assets successfully`);
